...
int main()
{
    ...
    if (new) {
        array[0] = 0;  // Количество запусков программы 1
        array[1] = 1;  // Количество запусков программы 2
        array[2] = 1;  // Общее количество запусков
    } else {
        // Если используется существующий сегмент, обновляем значения
        array[1] += 1;  // Увеличиваем счетчик запусков программы 2
